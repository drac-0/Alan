...
result * assembled(char * path){
      ...
      *Ret = (result){S,B, Lg, m,ma,Rm, data, Y_Pred};

      return Ret;
}

//2 video about how to use C function and structure in python
//Skipping the string topic because string is a fucker and i am not using it here
